...
public:
    ...
    void setAngles(double anx, double any, double anz) {
        angle_x = anx;
        angle_y = any;
        angle_z = anz;
    }
...
public slots:
    ...
    void RearView(void);                     // Standard view : rear view
...
private:
    ...
    void Draw_Box();                         // Draw the 3D box
    void NormalizeAngle(int *angle);         // Normalize angle between 0 and 360*16
