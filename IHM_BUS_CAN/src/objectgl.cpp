    ...
    QGLWidget(parent)
{
    ...
    Axis_X_Color = QColor::fromRgb(255, 0, 0, 255);   // Red for X axis
    Axis_Y_Color = QColor::fromRgb(0, 255, 0, 255);   // Green for Y axis
    Axis_Z_Color = QColor::fromRgb(0, 0, 255, 255);   // Blue for Z axis
...
void ObjectOpenGL::paintGL()
{
    ...
    // Light independent (color is constant)
    glLineWidth(5.0);
...
{
    // Use angleDelta instead of deprecated delta()
