...
void ObjectOpenGL::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ObjectOpenGL::xRotationChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ObjectOpenGL::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ObjectOpenGL::yRotationChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ObjectOpenGL::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ObjectOpenGL::zRotationChanged)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ObjectOpenGL::staticMetaObject = { {
    QMetaObject::SuperData::link<QGLWidget::staticMetaObject>(),
    qt_meta_stringdata_ObjectOpenGL.data,
    qt_meta_data_ObjectOpenGL,
    qt_static_metacall,
    nullptr,
    nullptr
} };
